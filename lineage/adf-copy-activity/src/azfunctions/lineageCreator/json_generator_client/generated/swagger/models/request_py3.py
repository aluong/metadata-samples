...
class Request(Model):
    ...
    def __init__(self, *, guid: str=None, name: str=None, type_name: str=None, qualified_name: str=None, created_by: str=None, process_attributes=None, inputs=None, outputs=None, **kwargs) -> None:
